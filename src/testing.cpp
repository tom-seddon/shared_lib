...
TestFailFnAdder::TestFailFnAdder(std::function<void(const TestFailArgs *)> fun) {
    this->Add(std::move(fun));
}

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

TestFailFnAdder::~TestFailFnAdder() {
    RemoveTestFailFnByContext(this);
}

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

void TestFailFnAdder::Add(std::function<void(const TestFailArgs *)> fun) {
    AddTestFailFn(std::move(fun), this);
}
